...
INPUT = r'Fresh/MarketPlaceJson.json'
OUT_JSX = r'src/pages/MarketPlaceReplica.jsx'
OUT_CSS = r'src/pages/MarketPlaceReplica.css'
...
css_lines.append('}')
css_lines.append('')
css_lines.append('.mpr-shell *, .mpr-shell *::before, .mpr-shell *::after {')
...
for rule in data.get('interactiveRules') or []:
    ...
    if not selector or not props:
        continue
    css_lines.append(f'.mpr-shell {selector} {{')
...
jsx_lines.append("import './MarketPlaceReplica.css';")
jsx_lines.append('')
jsx_lines.append('export default function MarketPlaceReplica() {')
...
jsx_lines.append('')
jsx_lines.append('  return (')
jsx_lines.append('    <div className="mpr-shell">')
